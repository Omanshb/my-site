...
const EXPERIENCES: Experience[] = [
  ...
  },
  {
    ...
    description: "Code review, guardrails, and observability for enterprise AI agents",
  ...
  },
  {
    company: "Qualys",
    role: "Software Engineering Intern",
    description: "Post-training infastructure",
...
export function ExperienceList() {
  return (
    <section className="mx-auto w-full max-w-4xl px-6 pb-12 pt-4">
      <ul className="border-t border-white/10">
        {EXPERIENCES.map((experience) => (
          <li
            key={experience.company}
            className="group relative isolate border-b border-white/10"
            style={
              {
